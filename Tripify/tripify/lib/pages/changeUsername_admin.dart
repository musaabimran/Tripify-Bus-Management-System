...
class ChangeUsernameAdmin extends StatefulWidget {
  final List colorUsed;
  final List fontsUsed;

  ChangeUsernameAdmin(this.colorUsed, this.fontsUsed);

  @override
  State<ChangeUsernameAdmin> createState() => _ChangeUsernameAdminState();
}
...
// the statefull class
class _ChangeUsernameAdminState extends State<ChangeUsernameAdmin> {
  @override
  void ChangeUsernameAdmin() async {
    if (_formkey.currentState!.validate()) {
      ...
      try {
        ...
        MyRoutes.index = 3; //specifying the index initallay will be 0
        Navigator.popAndPushNamed(context, MyRoutes.adminRoute);
      } catch (e) {
    ...
    return Container(
      child: Form(
        ...
        child: Column(children: [
          ...
          Button(widget.colorUsed, widget.fontsUsed, "Update",
              ChangeUsernameAdmin),
        ]),
      ),
    );
