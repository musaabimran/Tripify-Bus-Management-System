...
class ChangeUsernameDriver extends StatefulWidget {
  final List colorUsed;
  final List fontsUsed;

  ChangeUsernameDriver(this.colorUsed, this.fontsUsed);

  @override
  State<ChangeUsernameDriver> createState() => _ChangeUsernameDriverState();
}
...
// the statefull class
class _ChangeUsernameDriverState extends State<ChangeUsernameDriver> {
  @override
  void ChangeUsernameDriver() async {
