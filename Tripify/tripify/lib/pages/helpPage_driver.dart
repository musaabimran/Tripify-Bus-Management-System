...
class HelpPageDriver extends StatelessWidget {
  final List colorsUsed;
  final List fontsUsed;

  HelpPageDriver(this.colorsUsed, this.fontsUsed);
    ...
    return Column(
      children: [
        ...
        DropMedown(
            ...
            "Email us at support@tripify.com or contact us on this number 03227117752.",
            colorsUsed,
            fontsUsed),
        DropMedown(
            "Available locations?",
            "Currently tripify is only availble fo FAST NUCES Islamabad.",
            colorsUsed,
            fontsUsed),
        DropMedown(
        ...
        DropMedown("How to contact Admin?",
            "Contact Admin by email, admin@tripify.com", colorsUsed, fontsUsed),

        DropMedown("Salary issues?",
            "Contact Admin by email, admin@tripify.com", colorsUsed, fontsUsed),
