...
class All_Students_Return extends StatelessWidget {
  final String email;
  // take the username in it and show's the output
  All_Students_Return(this.email);
...
// A function to fetch all the document id's in the database
  ...
  Future? View_All_Student_info ()async {
  ...
  // FirebaseFirestore.instance.clearPersistence();
    ...
    // prepare the query
   final query = ref.where("selected_value", isEqualTo:1);
